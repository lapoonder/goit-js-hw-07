...
const insertImagesArray = [];
images.forEach(image => {
  const insertLi = document.createElement('li');
  insertLi.classList.add('list-image');
  const insertImage = document.createElement('img');
  insertImage.classList.add('gallery-image');
  insertImage.src = image.url;
  insertImage.alt = image.alt;
  insertLi.append(insertImage);
